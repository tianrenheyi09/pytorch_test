...
model = new_model(num_classes=2).to(device)

######参数修改
for param in model.pre_model.parameters():
    param.requires_grad = False
for param in model.pre_model.fc.parameters():
...
# ignored_params = list(map(id, model.new_fc2.parameters()))
